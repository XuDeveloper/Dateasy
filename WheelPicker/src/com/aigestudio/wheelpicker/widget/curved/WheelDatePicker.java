...
public class WheelDatePicker extends LinearLayout implements IWheelPicker {
    ...
    private void init() {
        ...
        addLabel(pickerYear, "骞�");
        addLabel(pickerMonth, "鏈�");
        addLabel(pickerDay, "鏃�");
    ...
    public void setCurrentTextBgColor(int color) {
        pickerYear.setCurrentTextBgColor(color);
        pickerMonth.setCurrentTextBgColor(color);
        pickerDay.setCurrentTextBgColor(color);
    }
