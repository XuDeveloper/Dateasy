...
public abstract class AbstractWheelPicker extends View implements IWheelPicker {
    ...
    protected int curBackgroundColor;
    ...
    protected void obtainAttrs(AttributeSet attrs) {
        ...
        int defCurTextBgColor = 0xFFFFFFFF;
        ...
        if (null != attrs) {
            ...
            curBackgroundColor = a.getColor(
                    R.styleable.AbstractWheelPicker_wheel_text_background_color_current, defCurTextBgColor);
            ...
            curBackgroundColor = defCurTextBgColor;
    ...
    @Override
    public void setCurrentTextBgColor(int color){
