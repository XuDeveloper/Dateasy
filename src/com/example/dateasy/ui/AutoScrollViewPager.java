...
public class AutoScrollViewPager extends LoopViewPager implements Handler.Callback {
    ...
    private AdvViewPagerScroller scroller = null;
    ...
    private void setViewPagerScroller() {
        try {
            ...
            scroller = new AdvViewPagerScroller(getContext(), interpolator, swipeScrollFactor);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (isAutoScroll && stopScrollWhenTouch) {
                isStopByTouch = true;
                scroller.setScrollDuration(swipeScrollFactor);
                stopAutoScroll();
            }
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case SCROLL_WHAT:
                if (isAutoScroll) {
                    scroller.setScrollDuration(autoScrollFactor);
                    scrollOnce();
                }
            default:
                break;
